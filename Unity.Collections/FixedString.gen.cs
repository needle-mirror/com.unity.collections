...
namespace Unity.Collections
{
    ...
    , IEquatable<FixedString4096>
    {
            ...
            get
            {
                unsafe
                {
                    fixed(FixedString32* t = &this)
                        return ref UnsafeUtility.AsRef<FixedListByte32>(t);
                }
            }
        }
        ...
        /// <summary>
        /// A property in order to display the value in the Entity Inspector.
        /// </summary>
        [CreateProperty] string Value => ToString();
            ...
            get
            {
                unsafe
                {
                    fixed(FixedString64* t = &this)
                        return ref UnsafeUtility.AsRef<FixedListByte64>(t);
                }
            }
        }
            ...
            get
            {
                unsafe
                {
                    fixed(FixedString128* t = &this)
                        return ref UnsafeUtility.AsRef<FixedListByte128>(t);
                }
            }
        }
            ...
            get
            {
                unsafe
                {
                    fixed(FixedString512* t = &this)
                        return ref UnsafeUtility.AsRef<FixedListByte512>(t);
                }
            }
        }
            ...
            get
            {
                unsafe
                {
                    fixed(FixedString4096* t = &this)
                        return ref UnsafeUtility.AsRef<FixedListByte4096>(t);
                }
            }
        }
