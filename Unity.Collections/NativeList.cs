...
{
    /// <summary>
    /// Contains a buffer for the elements of a <see cref="NativeList{T}"/>.
    /// </summary>
    /// <seealso cref="NativeListUnsafeUtility.GetInternalListDataPtrUnchecked{T}"/>
    unsafe struct NativeListData
    {
        /// <summary>
        /// The buffer containing the data.
        /// </summary>
        /// <value>An unsafe pointer.</value>
        public void*                            buffer;
        /// <summary>
        /// The number of items in the buffer.
        /// </summary>
        /// <value>The length of the list.</value>
        public int								length;
        /// <summary>
        /// The number of items that fit in the buffer.
        /// </summary>
        /// <value>The memory allocated for the buffer divided by the size of an item.</value>
        public int								capacity;
    }
