...
#pragma warning restore 0169
    ...
    {
        Assert.Throws<ArgumentException>(() => new NativeArraySOA<F1>(150, Allocator.Temp));
        Assert.Throws<ArgumentException>(() => new NativeArraySOA<F2>(150, Allocator.Temp));
        Assert.Throws<ArgumentException>(() => new NativeArraySOA<F3>(150, Allocator.Temp));
    }
